...
INSERT INTO visits (customer_id, representative_id, route_id, check_in_time, check_in_location, check_out_time, check_out_location, status, created_at, updated_at) VALUES
                                                                                                                                                                        ...
                                                                                                                                                                        (1, 4, 1, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 5, 0, '+03'), '33.5117,36.3067',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 40, 0, '+03'), '33.5117,36.3067', 'COMPLETED', NOW(), NOW()),  -- id 1
                                                                                                                                                                        (2, 4, 1, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 15, 0, '+03'), '33.5130,36.3200',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 45, 0, '+03'), '33.5130,36.3200', 'COMPLETED', NOW(), NOW()),  -- id 2
                                                                                                                                                                        (3, 4, 1, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 11, 20, 0, '+03'), '33.5050,36.2750',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 11, 50, 0, '+03'), '33.5050,36.2750', 'COMPLETED', NOW(), NOW()),  -- id 3

                                                                                                                                                                        -- Route 2 (rep 5, yesterday, COMPLETED) — 2 visited, 1 MISSED
                                                                                                                                                                        (4, 5, 2, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 10, 0, '+03'), '33.4830,36.3400',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 55, 0, '+03'), '33.4830,36.3400', 'COMPLETED', NOW(), NOW()),  -- id 4
                                                                                                                                                                        (5, 5, 2, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 30, 0, '+03'), '33.4700,36.3600',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 11, 0, 0, '+03'), '33.4700,36.3600', 'COMPLETED', NOW(), NOW()),  -- id 5
                                                                                                                                                                        (6, 5, 2, NULL, NULL, NULL, NULL, 'MISSED', NOW(), NOW()),                                                                           -- id 6  (shop closed)

                                                                                                                                                                        -- Route 3 (rep 6, yesterday, COMPLETED) — both visited
                                                                                                                                                                        (7, 6, 3, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 8, 50, 0, '+03'), '36.2010,37.1660',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 35, 0, '+03'), '36.2010,37.1660', 'COMPLETED', NOW(), NOW()),  -- id 7
                                                                                                                                                                        (8, 6, 3, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 5, 0, '+03'), '36.2070,37.1500',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 35, 0, '+03'), '36.2070,37.1500', 'COMPLETED', NOW(), NOW()),  -- id 8

                                                                                                                                                                        -- Route 4 (rep 7, yesterday, COMPLETED) — both visited
                                                                                                                                                                        (9,  7, 4, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 20, 0, '+03'), '36.1800,37.1580',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 50, 0, '+03'), '36.1800,37.1580', 'COMPLETED', NOW(), NOW()), -- id 9
                                                                                                                                                                        (10, 7, 4, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 40, 0, '+03'), '36.1700,37.1750',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 11, 25, 0, '+03'), '36.1700,37.1750', 'COMPLETED', NOW(), NOW()), -- id 10

                                                                                                                                                                        -- Route 5 (rep 8, yesterday, COMPLETED) — 2 visited, 1 MISSED
                                                                                                                                                                        (11, 8, 5, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 0, 0, '+03'), '34.7350,36.7140',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 30, 0, '+03'), '34.7350,36.7140', 'COMPLETED', NOW(), NOW()), -- id 11
                                                                                                                                                                        (12, 8, 5, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 10, 0, '+03'), '34.7500,36.6800',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 45, 0, '+03'), '34.7500,36.6800', 'COMPLETED', NOW(), NOW()), -- id 12
                                                                                                                                                                        (13, 8, 5, NULL, NULL, NULL, NULL, 'MISSED', NOW(), NOW()),                                                                          -- id 13 (owner away)

                                                                                                                                                                        -- Route 6 (rep 9, yesterday, COMPLETED) — both visited
                                                                                                                                                                        (14, 9, 6, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 15, 0, '+03'), '35.5197,35.7920',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 55, 0, '+03'), '35.5197,35.7920', 'COMPLETED', NOW(), NOW()), -- id 14
                                                                                                                                                                        (15, 9, 6, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 25, 0, '+03'), '35.5100,35.7800',
                                                                                                                                                                         make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 55, 0, '+03'), '35.5100,35.7800', 'COMPLETED', NOW(), NOW()), -- id 15

                                                                                                                                                                        -- Route 7 (rep 4, TODAY, ACTIVE) — rep is inside customer 1 right now
                                                                                                                                                                        (1, 4, 7, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE)::int, EXTRACT(MONTH FROM CURRENT_DATE)::int, EXTRACT(DAY FROM CURRENT_DATE)::int, 9, 5, 0, '+03'), '33.5117,36.3067',
...
INSERT INTO epod_artifacts (invoice_id, type, url, hash, latitude, longitude, captured_at, created_at, updated_at) VALUES
                                                                                                                       ...
                                                                                                                       (1, 'SIGNATURE',      'signatures/invoice_1.png', 'a1b2c3d4e5f60718293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801', 33.5117, 36.3067, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 38, 0, '+03'), NOW(), NOW()),
                                                                                                                       (1, 'DELIVERY_PHOTO', 'photos/invoice_1.jpg',     'b2c3d4e5f60718293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2', 33.5117, 36.3067, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 39, 0, '+03'), NOW(), NOW()),

                                                                                                                       -- Invoice 2 — customer 2, Sham Grocery
                                                                                                                       (2, 'SIGNATURE',      'signatures/invoice_2.png', 'c3d4e5f60718293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3', 33.5130, 36.3200, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 43, 0, '+03'), NOW(), NOW()),
                                                                                                                       (2, 'DELIVERY_PHOTO', 'photos/invoice_2.jpg',     'd4e5f60718293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4', 33.5130, 36.3200, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 44, 0, '+03'), NOW(), NOW()),

                                                                                                                       -- Invoice 3 — customer 4, Jaramana Superstore
                                                                                                                       (3, 'SIGNATURE',      'signatures/invoice_3.png', 'e5f60718293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5', 33.4830, 36.3400, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 52, 0, '+03'), NOW(), NOW()),
                                                                                                                       (3, 'DELIVERY_PHOTO', 'photos/invoice_3.jpg',     'f60718293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6', 33.4830, 36.3400, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 53, 0, '+03'), NOW(), NOW()),

                                                                                                                       -- Invoice 4 — customer 7, Aleppo Trade Center
                                                                                                                       (4, 'SIGNATURE',      'signatures/invoice_4.png', '0718293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f7', 36.2010, 37.1660, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 32, 0, '+03'), NOW(), NOW()),
                                                                                                                       (4, 'DELIVERY_PHOTO', 'photos/invoice_4.jpg',     '18293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f708', 36.2010, 37.1660, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 33, 0, '+03'), NOW(), NOW()),

                                                                                                                       -- Invoice 5 — customer 9, Salaheddine Market
                                                                                                                       (5, 'SIGNATURE',      'signatures/invoice_5.png', '8293a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f7081', 36.1800, 37.1580, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 47, 0, '+03'), NOW(), NOW()),
                                                                                                                       (5, 'DELIVERY_PHOTO', 'photos/invoice_5.jpg',     '93a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f708192', 36.1800, 37.1580, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 9, 48, 0, '+03'), NOW(), NOW()),

                                                                                                                       -- Invoice 6 — customer 5, Mleiha Corner Shop (SENT)
                                                                                                                       (6, 'SIGNATURE',      'signatures/invoice_6.png', 'a4b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f708192a3', 33.4700, 36.3600, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 58, 0, '+03'), NOW(), NOW()),
                                                                                                                       (6, 'DELIVERY_PHOTO', 'photos/invoice_6.jpg',     'b5c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f708192a3b4', 33.4700, 36.3600, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 59, 0, '+03'), NOW(), NOW()),

                                                                                                                       -- Invoice 7 — customer 10, Shahba Wholesaler (SENT)
                                                                                                                       (7, 'SIGNATURE',      'signatures/invoice_7.png', 'c6d7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f708192a3b4c5', 36.1700, 37.1750, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 11, 22, 0, '+03'), NOW(), NOW()),
                                                                                                                       (7, 'DELIVERY_PHOTO', 'photos/invoice_7.jpg',     'd7e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f708192a3b4c5d6', 36.1700, 37.1750, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 11, 23, 0, '+03'), NOW(), NOW()),
                                                                                                                       ...
                                                                                                                       (9, 'SIGNATURE',      'signatures/invoice_9.png', 'e8f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f708192a3b4c5d6e7', 36.2070, 37.1500, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 33, 0, '+03'), NOW(), NOW()),
                                                                                                                       (9, 'DELIVERY_PHOTO', 'photos/invoice_9.jpg',     'f901a2b3c4d5e6f708192a3b4c5d6e7f801a2b3c4d5e6f708192a3b4c5d6e7f8', 36.2070, 37.1500, make_timestamptz(EXTRACT(YEAR FROM CURRENT_DATE - 1)::int, EXTRACT(MONTH FROM CURRENT_DATE - 1)::int, EXTRACT(DAY FROM CURRENT_DATE - 1)::int, 10, 34, 0, '+03'), NOW(), NOW());
